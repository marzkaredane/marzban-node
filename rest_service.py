...
class Service(object):
    def __init__(self):
        ...
        # Health / liveness endpoints. Railway (and the Docker HEALTHCHECK)
        # probe GET /health. GET / is also exposed as a lightweight liveness
        # check. Neither requires an active Marzban connection or a session.
    ...
    def health(self):
        """Health probe used by Railway and the Docker HEALTHCHECK."""
        return {
            "status": "ok",
